...
export function DetectorSettingsView({ authenticated, onSync, onPreferencesChanged, onLogout, onConnectAccount, onAccountChanged }: {
  ...
  const sync = async () => {
    ...
    try {
      ...
      setMessage("Sincronización completada con AniList.");
    } catch (reason) {
  ...
  return <section className="detector-settings">
    <AccountSettingsView onConnect={onConnectAccount} onAccountChanged={onAccountChanged} />
    ...
    {preferences && <div className="profile-settings">
      <div className="profile-heading">
        ...
        <div><h2>{preferences.username}</h2><span>Cuenta conectada a AniList</span></div>
      </div>
