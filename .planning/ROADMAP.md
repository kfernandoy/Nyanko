...
- [x] 03-03-PLAN.md — La ruta `/assets/pages/{page_id:path}` declarada ANTES del mount (D-04) + test de traversal (D-05) — RD-01 — wave 2

**Wave 3** *(blocked on Wave 2)*

- [x] 03-04-PLAN.md — API `/api/manga/*` (capítulos, páginas, prefs, progreso, evento) + WR-06 — RD-03, RD-05, RD-06, RD-07 — wave 3
